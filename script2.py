...
class AdvancedPDFLogoRemover:
    ...
    def process_pdf_batch(self, input_dir: str = "input2", output_dir: str = "outputModificado2",
                         confidence_threshold: float = 0.5,
                         remove_text_blocks_flag: bool = True,
                         remove_links_flag: bool = True,
                         aggressive_link_removal: bool = False,
...
def main():
    ...
    parser.add_argument("--input_dir", default="input2", help="Carpeta de entrada para procesamiento en lote")
    parser.add_argument("--output_dir", default="outputModificado2", help="Carpeta de salida para procesamiento en lote")
