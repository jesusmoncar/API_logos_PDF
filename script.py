...
KEYWORDS_TO_REMOVE_MULTILANG = {
    ...
    'english': [
        ...
        "contact us", "powered by", "generated by"
    ],
    'french': [
        ...
        "mention légale", "cookies", "confidentialité", "marque déposée"
    ],
    'german': [
        ...
        "cookies", "datenschutz", "eingetragene marke"
    ],
    'italian': [
        ...
        "cookies", "privacy", "marchio registrato"
    ],
    'portuguese': [
        ...
        "aviso legal", "cookies", "privacidade", "marca registrada"
    ]
}
...
TEXT_BLOCKS_TO_REMOVE_MULTILANG = {
    'spanish': [
        ...
        "Este documento es confidencial", "Uso interno únicamente"
    ],
    'english': [
        ...
        "Customer Service", "All rights reserved", "Copyright notice"
    ],
    'french': [
    ...
    'portuguese': [
        ...
        "Este documento é confidencial", "Apenas para uso interno"
    ]
}
...
class OCRDetector:
    ...
    def detect_language(self, text_list: List[str]) -> str:
        ...
        language_indicators = {
            'spanish': ['ayuda', 'soporte', 'empresa', 'contacto', 'política', 'términos', 'aviso', 'derechos'],
